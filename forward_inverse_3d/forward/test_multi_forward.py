import time
from forward_inverse_3d.forward.forward_coupled_matrix_form import (
    compute_d_from_tmp as compute_d_coupled_matrix,
)
from forward_inverse_3d.forward.forward_coupled_ischemia import (
    compute_d_from_tmp as compute_d_coupled_ischemia,
)
from forward_inverse_3d.forward.forward_coupled import (
    compute_d_from_tmp as compute_d_coupled,
)
from forward_inverse_3d.forward.forward_ecgsim import (
    compute_d_from_tmp as compute_d_ecgsim,
)
