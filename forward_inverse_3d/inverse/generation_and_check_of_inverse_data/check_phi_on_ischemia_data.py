...
max_timeframe = 400
v_exact_all_time = np.load(v_data_file)[0:max_timeframe]
phi_1_exact = np.load(phi_1_file)[0:max_timeframe]
phi_2_exact = np.load(phi_2_file)[0:max_timeframe]

p1 = multiprocessing.Process(
    target=plot_vals_on_mesh,
    kwargs={
        "mesh_file": mesh_file,
