...
from forward_inverse_3d.forward.forward_coupled import (
    compute_d_from_tmp as compute_d_from_tmp_coupled,
)
from forward_inverse_3d.forward.forward_decoupled import (
    compute_d_from_tmp as compute_d_from_tmp_decoupled,
)
...
v_data, _, _ = compute_v_based_on_reaction_diffusion(
    mesh_file, ischemia_flag=False, T=T, step_per_timeframe=step_per_timeframe
)
