...
from utils.visualize_tools import (
    plot_bsp_on_standard12lead,
    plot_activation_times_on_mesh,
    plot_v_random,
    plot_val_on_mesh,
)
...
if __name__ == "__main__":
    ...
    activation_dict = {8: np.array([46.8, 39.7, -40.9])}
    ...
    p1 = multiprocessing.Process(
        target=plot_bsp_on_standard12lead,
        args=(d_data,),
        kwargs={
            'step_per_timeframe': step_per_timeframe,
            'filter_flag': False,
    ...
    p2 = multiprocessing.Process(
        target=plot_v_random,
        args=(v_data,),
        kwargs={'step_per_timeframe': step_per_timeframe},
    )
    p3 = multiprocessing.Process(
        target=plot_activation_times_on_mesh,
